...
if(isset($_POST["submitButton"])){
    if(empty($_POST['student_id']) || empty($_POST['fname']) || empty($_POST['lname']) || empty($_POST['address']) || empty($_POST['birthday']) || empty($_POST['email'])){
    ...
    $query = "INSERT INTO `student_information`(`student_id`, `fname`, `mname`, `lname`, `address`, `birthday`, `email`) 
    VALUES ('$student_id','$fname','$mname','$lname','$address','$birthday','$email')";
    $query_result = mysqli_query( $con, $query );
...
if(isset($_POST["updateButton"])){
    ...
    $query = "UPDATE `student_information` SET `student_id`='$student_id',`fname`='$fname',`mname`='$mname',`lname`='$lname',`address`='$address',`birthday`='$birthday',`email`='$email' WHERE id = $id";
