            ...
            <form action="process.php" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" placeholder="Enter Middle Name" class="form-control" name="mname">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" placeholder="Enter your Birthday" class="form-control" name="birthday">
                    </div>
                    ...
                    <div class="col-md-12 mb-3 text-center">
                        <button type="submit" class="btn btn-primary" name="submitButton" style="float: right;">Submit</button>
                    </div>
                </div>
            </form>
        </div>
